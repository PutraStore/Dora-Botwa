...
"headerType": "DOCUMENT", "documentMessage": {
            ...
            "jpegThumbnail": await (await fetch('https://telegra.ph/file/b0b264fd2e3b34cfc5774.jpg')).buffer(),
      ...
      case 'demote':
        ...
        if (chat.detect) this.send2ButtonLoc(jid, banp, text, '🎮 Dora bot', 'MENU', '#menu', 'OWNER', '#owner', null, {
          contextInfo: {
...
`.trim(), '🎮 Dora bot', 'DISABLE DELETE', '.disable delete', {
      quoted: m.message,
      contextInfo: {
